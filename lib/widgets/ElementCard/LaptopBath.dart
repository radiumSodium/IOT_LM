...
class LaptopBath extends StatefulWidget {
  const LaptopBath({super.key});

  @override
  State<LaptopBath> createState() => _LaptopBathState();
}

class _LaptopBathState extends State<LaptopBath> {
  bool val1 = true;
