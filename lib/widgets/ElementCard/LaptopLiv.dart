...
class LaptopLiv extends StatefulWidget {
  const LaptopLiv({super.key});

  @override
  State<LaptopLiv> createState() => _LaptopLivState();
}

class _LaptopLivState extends State<LaptopLiv> {
  bool val1 = true;
