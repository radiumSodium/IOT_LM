...
class OtherBath extends StatefulWidget {
  const OtherBath({super.key});

  @override
  State<OtherBath> createState() => _OtherBathState();
}

class _OtherBathState extends State<OtherBath> {
  bool val1 = true;
